...
module.exports = (robot) ->
  ...
  robot.respond /cumberbatch( me)?/i, (msg) ->
    if _.random(0, 10) > 9
      msg.reply msg.random fullnames
    else
      msg.reply "#{msg.random firstnames} #{msg.random lastnames}"