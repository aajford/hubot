...
#   hubot newrelic android crashes - Returns the crash rate and crash number for the Sky News Android app in the last 24 hours
#   hubot newrelic iphone crashes - Returns the crash rate and crash number for the Sky News iPhone app in the last 24 hours
#
# Authors:
#   statianzo
#
...
plugin = (robot) ->
  ...
  today = yyyy + '-' + mm + '-' + dd + 'T' + hour + ':' + minute + ':' + second + '+00:00'
  yesterday = yyyy + '-' + mm + '-' + ddy + 'T' + hour + ':' + minute + ':' + second + '+00:00'  
  ...
  robot.respond /(newrelic|nr) iphone crashes$/i, (msg) ->
    ...
    requestMobile "9550949.json", '', (err, json) ->
      if err
        ...
        msg.send "iphone (prod) app, past 24 hours...\nCrashes: #{json.application.crash_summary.crash_count}\nCrash Rate: #{json.application.crash_summary.crash_rate}"
