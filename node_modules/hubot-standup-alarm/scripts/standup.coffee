...
module.exports = (robot) ->
  ...
  # Constants.
  STANDUP_MESSAGES = [
    '@channel Standup time!\n http://appear.in/SuperAwesomeStandupMorningTime'
    '@channel Time for standup, y\'all.\n http://appear.in/EVERYTHINGISSTILLAWESOME'
    '@channel It\'s standup time once again!\n http://appear.in/Everythingiscoolwhenyourepartofateam'
    '@channel Get up, stand up (it\'s time for our standup)\n http://appear.in/getupstandupp'
    '@channel Standup time. Get up, humans\n http://appear.in/ilovestandingup'
