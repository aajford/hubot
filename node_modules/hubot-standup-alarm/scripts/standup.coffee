...
module.exports = (robot) ->
  ...
  # Constants.
  STANDUP_MESSAGES = [
    '@channel Standup time! /appear SuperAwesomeStandupMorningTime'
    '@channel Time for standup, y\'all. /appear EVERYTHING IS STILL AWESOME'
    '@channel It\'s standup time once again! /appear Everything is cool when youre part of a team'
    '@channel Get up, stand up (it\'s time for our standup) /appear get up stand up'
    '@channel Standup time. Get up, humans /appear i love standing up'
    '@channel Standup time! Now! Go go go! /appear sitting down is overrated'
  ]
